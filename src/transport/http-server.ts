...
const TOOLS = [
  ...
  { name: "cognition_query", description: "Query the cognition graph by nodeType (INTENT/PATTERN/CONSTRAINT/HEURISTIC), filePath, language, or semanticHash", inputSchema: { type: "object", properties: { nodeType: { type: "string", enum: ["INTENT", "PATTERN", "CONSTRAINT", "HEURISTIC"] }, filePath: { type: "string" }, language: { type: "string" }, contextHash: { type: "string" }, semanticHash: { type: "string" }, intentHint: { type: "string", enum: ["REFACTOR", "BUGFIX", "BOILERPLATE"] }, maxDepth: { type: "number" }, limit: { type: "number" } } } },
